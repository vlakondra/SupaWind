<script>
    ...
    onMount(async () => {
        var ggbApplet = await new GGBApplet(parameters1, "5.0");
         
        // await console.log(1234,Object.keys(ggbApplet) );
        // let obj = ggbApplet.getAppletObject()

        // await window.GGBApplet.registerObjectClickListener("A",upd)
        //  app1.setGridVisible(true)
        // console.log('app1',app1) 

        await ggbApplet.inject("appcont");
        // await ggbApplet.registerUpdateListener(upd);

        //await console.log(window)
        // const app = ggbApplet;
          //console.log('app',app)
        // app.registerObjectClickListener("A",upd)
    });
    ...
    //tick();
    //await tick();
    setTimeout(()=> app1.registerObjectClickListener("A",()=>console.log("22")),2000)
    console.log('the component just updated');
     ...
     function regs(){
        console.log('key')
         app1.registerObjectClickListener("A",()=>console.log("22"))
...
<p>
    <input value="eval" on:click={aa} type="button" />
</p>
